...
- Session management
- Next.js 16 Proxy refresh and route redirects for /dashboard, /profile, /find-jobs, /find-jobs/[id], plus server-side user validation before protected content/data access
- After login → redirect to /dashboard

---

**Implementation note (2026-09-13):** Auth uses `@insforge/sdk/ssr`, server-owned OAuth at `/api/auth/callback`, and a minimal authenticated dashboard destination. Session-aware homepage CTAs are included. See `context/auth-implementation.md`. Real-account OAuth and visual validation remain pending.
